...
![封面图：GPT-5.5 与 Claude Opus 4.7 站上同一张工作台](imgs/00-cover.png)

时间范围：2026-04-16 至 2026-04-24  
写作定位：热点快评型  
一句话判断：GPT-5.5 和 Opus 4.7 的竞争，已经不是“谁更会聊天”，而是谁更能在真实工作流里把事做完。

## 标题候选

1. GPT-5.5 刚发布，AI 大模型真正卷到“干活”了
2. GPT-5.5 对上 Opus 4.7：这次比的不是嘴，是手
3. OpenAI 和 Anthropic 都摊牌了：下一代 AI 是“工作型模型”
4. GPT-5.5 为什么重要？因为它把 Agent 战争推到台前
5. 别只看跑分：GPT-5.5 和 Opus 4.7 到底怎么选？

主标题选择：**GPT-5.5 刚发布，AI 大模型真正卷到“干活”了**

## 优化摘要

OpenAI 在 4 月 23 日发布 GPT-5.5，Anthropic 在 4 月 16 日发布 Claude Opus 4.7。两家公司这次讲的不是“更会聊天”，而是编码、查资料、操作软件、处理文档、长期执行任务。我的判断是：大模型竞争正在从“回答质量”转向“工作完成度”。GPT-5.5 更像一台跨工具执行引擎，Opus 4.7 更像一个稳、长、细的高级工程搭档。
...
| 热点 | 日期 | 可信度 | 关键信息源 |
|---|---:|---|---|
| GPT-5.5 发布 | 2026-04-23 | High | [OpenAI 发布页](https://openai.com/index/introducing-gpt-5-5/)、[GPT-5.5 System Card](https://openai.com/index/gpt-5-5-system-card/) |
| Claude Opus 4.7 发布 | 2026-04-16 | High | [Anthropic 发布页](https://www.anthropic.com/news/claude-opus-4-7)、[Claude Opus 产品页](https://www.anthropic.com/claude/opus) |
| Claude API 定价与 tokenizer | 2026-04 | High | [Anthropic pricing docs](https://platform.claude.com/docs/en/about-claude/pricing) |
